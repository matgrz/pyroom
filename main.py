...
all_feature_lists1 = room.receive_features(config.mic_location1, 10, 0.20, angle_from_first_pair, fr_limit=10)
all_feature_lists2 = room.receive_features(config.mic_location2, 10, 0.20, angle_from_second_pair, fr_limit=10)
